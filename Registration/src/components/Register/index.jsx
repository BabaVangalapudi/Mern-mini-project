    ...
    <div className='container'>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className='input-each'>
          ...
          <input className='input-box' type="email" name='email' autoComplete='off' placeholder='Enter your email' id='email' value={email} 
          onChange={(e)=>setEmail(e.target.value)}/>
        </div>
        <div className='input-each'>
          <label htmlFor="password">Password</label>
          <input className='input-box' type="password" name='password' autoComplete='off' placeholder='Set your password' id='password' value={password} 
          onChange={(e)=>setPassword(e.target.value)}/>
        </div>
        <div className='input-each'>
          <label htmlFor="confirm">Confirm Password</label>
          <input className='input-box' type="text" name='confirm' placeholder='Confirm your password' autoComplete='off' id='confirmpass' value={confirmpass} 
